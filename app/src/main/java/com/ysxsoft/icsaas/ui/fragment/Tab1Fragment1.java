 ...
 * on 2020/3/4 0004
 */
public class Tab1Fragment1 extends BaseFragment implements OnRefreshLoadMoreListener, View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_tab1_tab1;
    }
    ...
    public void onClick(View v) {
        iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ViewCompat.animate(iv).scaleYBy(0.2f).scaleXBy(0.2f).setDuration(100).setInterpolator(new DecelerateInterpolator()).setListener(new ViewPropertyAnimatorListener() {
                    @Override
