...
import com.ysxsoft.icsaas.ui.activity.ApplyDetialActivity;
 ...
 * on 2020/3/10 0010
 */
public class FileCirculationFragment1 extends BaseFragment implements OnRefreshLoadMoreListener {
...
//                tvName.setText("办理人员：");
        ...
        adapter.setOnItemClickListener(new RBaseAdapter.OnItemClickListener() {
            ...
            public void onItemClick(RViewHolder holder, View view, int position) {
                toActivity(ApplyDetialActivity.class);
            }
        });
