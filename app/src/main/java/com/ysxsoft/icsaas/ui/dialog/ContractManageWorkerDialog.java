 ...
 * on 2020/3/9 0009
 */
public class ContractManageWorkerDialog extends ABSDialog implements OnRefreshLoadMoreListener {
    int page = 1;
    private SmartRefreshLayout smartRefresh;
    private Context context;
    private int type;

    public ContractManageWorkerDialog(@NonNull Context context) {
