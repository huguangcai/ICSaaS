...
import static com.ysxsoft.icsaas.common_base.utils.DisplayUtils.dp2px;
...
public class BitmapUtils {
    ...
    public static Bitmap createWaterMaskCenter(Bitmap src, Bitmap watermark) {
        double scaleWidth = src.getWidth() * 0.4;
        double scaleHeight = watermark.getHeight() * scaleWidth / watermark.getWidth();
        Bitmap scaleWatermark = BitmapUtils.scaleWithWH(watermark, scaleWidth, scaleHeight);
        return createWaterMaskBitmap(src, scaleWatermark, (src.getWidth() - scaleWatermark.getWidth()) / 2, (src.getHeight() - scaleWatermark.getHeight()) / 2);
    }
