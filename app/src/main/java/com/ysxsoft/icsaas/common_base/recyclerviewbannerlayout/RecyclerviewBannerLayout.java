package com.ysxsoft.icsaas.common_base.recyclerviewbannerlayout;
...
import com.ysxsoft.icsaas.common_base.recyclerviewbannerlayout.layoutmanager.BannerLayoutManager;
import com.ysxsoft.icsaas.common_base.recyclerviewbannerlayout.layoutmanager.CenterSnapHelper;
...
public class RecyclerviewBannerLayout extends FrameLayout {
    ...
    public RecyclerviewBannerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerviewBannerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RecyclerviewBannerLayout);
        showIndicator = a.getBoolean(R.styleable.RecyclerviewBannerLayout_showIndicator, true);
        autoPlayDuration = a.getInt(R.styleable.RecyclerviewBannerLayout_interval, 4000);
        isAutoPlaying = a.getBoolean(R.styleable.RecyclerviewBannerLayout_autoPlaying, true);
        itemSpace = a.getInt(R.styleable.RecyclerviewBannerLayout_itemSpace, 20);
        centerScale = a.getFloat(R.styleable.RecyclerviewBannerLayout_centerScale, 1.2f);
        moveSpeed = a.getFloat(R.styleable.RecyclerviewBannerLayout_moveSpeed, 1.0f);
        ...
        int o = a.getInt(R.styleable.RecyclerviewBannerLayout_orientation, 0);
        int orientation = 0;
        if (o == 0) {
